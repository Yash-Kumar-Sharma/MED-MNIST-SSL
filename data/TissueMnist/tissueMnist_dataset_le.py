...
class TissueMnist_DataModule_le(pl.LightningDataModule):
    def __init__(self, model, config):
        ...
        self.labels_portion = config.post_training.labels_portion
    ...
    def setup(self, stage):
        ...
        train_set = TissueMNIST(root = self.data_dir,
        ...
        test_set = TissueMNIST(root = self.data_dir,
                                         transform = normalized_transform,
                                         split = "test",
                                         download = False)
