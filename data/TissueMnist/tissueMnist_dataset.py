...
from data.OurModel_Data import OurDataFromTissueMnist
...
class TissueMnist_DataModule(pl.LightningDataModule):
    ...
    def setup(self, stage):
        ...
        if(stage == "fit"):
            ...
            if(self.model_name == "Our" or self.model_name == "OurV2" or self.model_name == "Modified_Simclr2" or self.model_name == "Modified_Simclr3"
                   or self.model_name == "NmixSimSiam" or self.model_name == "OurV3" or self.model_name == "OurV5" or self.model_name == "OurV6"):
                self.train_set = OurDataFromTissueMnist(K=self.K,
                                         root = self.data_dir,
