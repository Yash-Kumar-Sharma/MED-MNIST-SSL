...
from data.OurModel_Data import OurDataFromRetinaMnist
...
class RetinaMnist_DataModule(pl.LightningDataModule):
    ...
    def setup(self, stage):
        ...
        if(stage == "fit"):
            ...
            if(self.model_name == "MedMnist_SSL"):
                self.train_set = OurDataFromRetinaMnist(K=self.K,
                                         root = self.data_dir,
    ...
    def on_after_batch_transfer(self, batch, dataloader_idx):
        ...
        if self.trainer.training:
            ...
            if(self.model_name == "MedMnist_SSL"):     
                ...
                train_x_transform = self.transform.transforms_retina(train_x_transform)
