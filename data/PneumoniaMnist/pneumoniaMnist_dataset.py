...
from data.OurModel_Data import OurDataFromPneumoniaMnist
...
class PneumoniaMnist_DataModule(pl.LightningDataModule):
    ...
    def setup(self, stage):
        ...
        if(stage == "fit"):
            ...
            if(self.model_name == "MedMnist_SSL"):     
                self.train_set = OurDataFromPneumoniaMnist(K=self.K,
                                         root = self.data_dir,
